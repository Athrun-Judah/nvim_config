...
_G.packer_plugins = {
  ...
  ["nvim-lsp-ts-utils"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/nvim-lsp-ts-utils",
  ...
  ["nvim-treesitter-refactor"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/nvim-treesitter-refactor",
  ...
  ["schemastore.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/schemastore.nvim",
    url = "https://github.com/b0o/schemastore.nvim"
  },
  sniprun = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/sniprun",
